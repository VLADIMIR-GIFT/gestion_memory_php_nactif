<?php
// source: E:\projet_php_nactive\mon-projet-nette/config/common.neon
// source: E:\projet_php_nactive\mon-projet-nette/config/services.neon
// source: array
...
class Container_7242da4da6 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'E:\projet_php_nactive\mon-projet-nette/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('E:\projet_php_nactive\mon-projet-nette/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_7242da4da6 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\projet_php_nactive\mon-projet-nette/temp/cache/latte');
